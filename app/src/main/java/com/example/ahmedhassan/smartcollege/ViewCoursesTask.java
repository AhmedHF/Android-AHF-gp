...
public class ViewCoursesTask extends AsyncTask<String, String, String> {
    ...
    private ArrayList<Course> getAllcoursesFromJSON(String strjson)
        ...
        for (int i = 0; i < courses.length(); i++) {
            ...
            //String count=nameObject.getString("count").toString();
           // course.setCount("0");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String data = URLEncoder.encode("method", "UTF-8") + "=" + URLEncoder.encode(method, "UTF-8")
                    + "&" + URLEncoder.encode("StudentDataID", "UTF-8") + "=" + URLEncoder.encode(params[2], "UTF-8");
